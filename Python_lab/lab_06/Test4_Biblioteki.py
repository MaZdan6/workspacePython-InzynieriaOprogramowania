...
krotkiWprowadzane.append((" dodaj ", "Dziady ", " Adam Mickiewicz ", 2000) );
krotkiWprowadzane.append((" dodaj ", "Fundacja i Imperium ", " Isaac Asimov ", 2014));
...
krotkiWprowadzane.append((" wypozycz ", " Bartek Perkowski ", "Fundacja i Imperium "));
krotkiWprowadzane.append((" wypozycz ", " Bartek Perkowski ", "Dziady "));

liczba_wprowadzanych_krotek = len(krotkiWprowadzane);
